...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            @if($record)
                <form method="post" action="{{url('dashboard/dynamic-edit/aboutRow-update/'.$record->id)}}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <a href="{{url('dashboard/dynamic-edit/aboutRow-delete/'.$single)}}"><button class="btn-danger" type="button">Sil</button></a>
                                </div>
                                <div class="col-md-11">
            ...
            @else
                <form method="post" action="{{url('dashboard/dynamic-edit/aboutRow-insert')}}">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <label for="">Title :</label>
