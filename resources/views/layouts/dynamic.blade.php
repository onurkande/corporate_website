...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{url('dashboard/dynamic-edit')}}">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white {{ Request::is('dashboard/dynamic-edit/featured-project') ? 'active bg-gradient-primary':'' }}" href="{{url('dashboard/dynamic-edit/featured-project')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-list"></i>
            </div>
            <span class="nav-link-text ms-1">Featured Project</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white {{ Request::is('dashboard/dynamic-edit/sliders') ? 'active bg-gradient-primary':'' }}" href="{{url('dashboard/dynamic-edit/sliders')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-images"></i>
            </div>
            <span class="nav-link-text ms-1">Slider Yönetimi</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white {{ Request::is('dashboard/dynamic-edit/info-box') ? 'active bg-gradient-primary':'' }}" href="{{url('dashboard/dynamic-edit/info-box')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-list"></i>
            </div>
            <span class="nav-link-text ms-1">Info Box</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white {{ Request::is('dashboard/dynamic-edit/info') ? 'active bg-gradient-primary':'' }}" href="{{url('dashboard/dynamic-edit/info')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-list"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white {{ Request::is('dashboard/dynamic-edit/our-services') ? 'active bg-gradient-primary':'' }}" href="{{url('dashboard/dynamic-edit/our-services')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-list"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white {{ Request::is('dashboard/dynamic-edit/service-detail') ? 'active bg-gradient-primary':'' }}" href="{{url('dashboard/dynamic-edit/service-detail')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-list"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white {{ Request::is('dashboard/dynamic-edit/team') ? 'active bg-gradient-primary':'' }}" href="{{url('dashboard/dynamic-edit/team')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-list"></i>
            </div>
